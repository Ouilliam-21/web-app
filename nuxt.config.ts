...
export default defineNuxtConfig({
  ...
  runtimeConfig: {
    ...
    digitalOceanTokenWrite: process.env.DIGITAL_OCEAN_TOKEN_WRITE,
    ...
    gpuId: process.env.GPU_ID,
    gpuName: process.env.GPU_NAME,
    gpuRegion: process.env.GPU_REGION,
    gpuSize: process.env.GPU_SIZE,
    gpuImage: process.env.GPU_IMAGE,
    gpuSshKeys: process.env.GPU_SSH_KEYS,
  },
